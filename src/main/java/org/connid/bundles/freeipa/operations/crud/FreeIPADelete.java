...
public class FreeIPADelete {

    private static final Log LOG = Log.getLog(FreeIPADelete.class);
    ...
    public FreeIPADelete(final ObjectClass oclass, final Uid uid, final OperationOptions options,
